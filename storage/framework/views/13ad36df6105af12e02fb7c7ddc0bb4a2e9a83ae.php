    ...
    <div class="box-body" style="background: #ecf0f5">
        ...
        <div class="col-md-12">
            <div class="box box-sombra" style="border-top: none">
                <div class="box-body">
                    <div class="col-md-2">
                        <a class="btn btn-warning btnTransferirEntreCuentas" title="Transferir"  style="margin-left:15px" data-toggle="modal" data-target="#modalTransferencia" data-id="<?php echo e($cuenta->id); ?>" data-nombre="<?php echo e($cuenta->nombre); ?>">Transferir <i class="fa fa-exchange"></i></a>
                    </div>
