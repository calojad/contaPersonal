<?php echo Form::open(['url'=>'/transaccion/update','method'=>'post']); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="categoriasIngreso" value="<?php echo e($categoriasIngreso); ?>">
                <input type="hidden" name="categoriasGasto" value="<?php echo e($categoriasGasto); ?>">
