<div class="modal fade" id="modalFormIngreso" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?php echo Form::open(['url'=>'/transaccion/ingreso/create','method'=>'post']); ?>
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<?php echo e(Form::select('categoria_transac_id',$categoriasIngreso,null,['class'=>'form-control','required'=>true])); ?>
