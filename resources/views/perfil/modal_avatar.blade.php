                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="users-list clearfix" style="border-top: 1px solid lightgray">
                            <li>
                                <a class="aUserImageProfileDefault"><img class="img-rounded img-responsive" src="{{asset('adminLTE-2.4.3/dist/img/avatar.png')}}" alt="Avatar 1"></a>
                            </li>
                            <li>
                                <a class="aUserImageProfileDefault"><img class="img-rounded img-responsive" src="{{asset('adminLTE-2.4.3/dist/img/avatar2.png')}}" alt="Avatar 3"></a>
                            </li>
                            <li>
                                <a class="aUserImageProfileDefault"><img class="img-rounded img-responsive" src="{{asset('adminLTE-2.4.3/dist/img/avatar3.png')}}" alt="Avatar 3"></a>
                            </li>
                            <li>
                                <a class="aUserImageProfileDefault"><img class="img-rounded img-responsive" src="{{asset('adminLTE-2.4.3/dist/img/avatar04.png')}}" alt="Avatar 4"></a>
                            </li>
                            <li>
                                <a class="aUserImageProfileDefault"><img class="img-rounded img-responsive" src="{{asset('adminLTE-2.4.3/dist/img/avatar5.png')}}" alt="Avatar 5"></a>
                            </li>
                        </ul>
                    </div>
                </div>
